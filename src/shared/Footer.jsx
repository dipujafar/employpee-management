...
const Footer = () => {
    return (
        <footer className="relative w-full mt-10 bg-gray-300 p-5 rounded">
        <div className="mx-auto w-full max-w-7xl px-8">
          <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
            ...
            <div>
                <div className="flex gap-10">
                    <div>
                        <h1 className="text- font-semibold text-orange-400">OUR BRANCH</h1>
                        <p className="text-sm">
                            XYZ Road, Dhaka
                            <br />
                            XYZ Tower 5th floor
                    ...
                    <div>
                    <h1 className="text- font-semibold text-orange-400">IMPORTANT LINK</h1>
                    <ul>
                        <li><Link>About Us</Link></li>
                        <li><Link>Why Choose Us</Link></li>
          ...
          <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
            ...
            >
              &copy; {currentYear} <a href="https://material-tailwind.com/">JUIT</a>. All
              Rights Reserved.
            </Typography>
